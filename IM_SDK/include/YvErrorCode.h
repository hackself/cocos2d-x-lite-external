...
typedef enum
{
	...
	YvErrorCodeChatWorldBanned      =  1004,    //channel chat by banned
    ...
    YvErrorCodeIsplaying            =  1906,    //play file playing
    YvErrorCodeIsreocrding          =  1907,    //file isreocrding
